...
(atom-one-dark-with-color-variables
  (custom-theme-set-faces
   ...
   ;; mode-line
   `(mode-line ((t (:background ,atom-one-dark-black :foreground ,atom-one-dark-mono-1 :box (:color ,atom-one-dark-border :line-width 1)))))
   `(mode-line-buffer-id ((t (:weight bold))))
   `(mode-line-emphasis ((t (:weight bold :background ,atom-one-dark-green))))
   `(mode-line-inactive ((t (:background ,atom-one-dark-bg :foreground ,atom-one-dark-gray :box (:color ,atom-one-dark-border :line-width 1)))))
